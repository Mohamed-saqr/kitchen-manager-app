  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _buildRatingSlider(
          "chef_details.kpi.attendance".tr(),
          "attendance",
          Colors.orange,
        ),
        _buildRatingSlider(
          "chef_details.kpi.food_safety".tr(),
          "food_safety",
          Colors.green,
        ),
        _buildRatingSlider(
          "chef_details.kpi.hygiene".tr(),
          "hygiene",
          Colors.blue,
        ),
        _buildRatingSlider(
          "chef_details.kpi.waste_control".tr(),
          "waste_control",
          Colors.red,
        ),
